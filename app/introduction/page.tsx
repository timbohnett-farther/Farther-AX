  ...
  return (
    <div className="min-h-screen bg-cream text-charcoal">
      ...
      <div className="fixed top-6 right-8 z-50">
        <span className="font-sans text-xs tracking-[0.2em] uppercase text-charcoal-muted glass-card px-4 py-2 rounded-full">
          01 / 13
        </span>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-20 lg:py-28">
        ...
        <header className="mb-20">
          ...
          <h1 className="font-serif text-5xl lg:text-6xl text-charcoal leading-tight mb-5 tracking-tight">
            Welcome to the<br />
            <span className="text-gold">AX Playbook</span>
          </h1>
          <p className="font-sans text-base text-charcoal-muted tracking-wide">
        ...
        <section className="mb-20">
          <div className="glass-card rounded-2xl px-10 py-10">
            <p className="font-sans text-base leading-8 text-charcoal">
              ...
              <strong className="text-charcoal font-semibold">AX Associates (AXAs)</strong> through every step of
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="glass-card rounded-2xl p-8 group">
              ...
              <h3 className="font-serif text-xl text-charcoal mb-2">Breakaway</h3>
              <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-4">
                Wirehouse / Captive Firm
              </p>
              <p className="font-sans text-sm leading-7 text-charcoal">
            ...
            <div className="glass-card rounded-2xl p-8 group">
              ...
              <h3 className="font-serif text-xl text-charcoal mb-2">Independent RIA</h3>
              <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-4">
                Existing RIA Owner
              </p>
              <p className="font-sans text-sm leading-7 text-charcoal">
            ...
            <div className="glass-card rounded-2xl p-8 group">
              ...
              <h3 className="font-serif text-xl text-charcoal mb-2">M&amp;A</h3>
              <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-4">
            ...
            <div className="glass-card rounded-2xl p-8 group">
              ...
              <h3 className="font-serif text-xl text-charcoal mb-2">No to Low AUM</h3>
              <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-4">
                Below $15–20M AUM
              </p>
              <p className="font-sans text-sm leading-7 text-charcoal">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <h3 className="font-serif text-lg text-charcoal">Master Merge</h3>
                  </div>
                  <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-3 pl-5">
                    Fastest Method
                  </p>
                  <p className="font-sans text-sm leading-7 text-charcoal pl-5">
            ...
            <div className="glass-card rounded-2xl px-8 py-7">
              <div className="flex flex-col sm:flex-row sm:items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <div className="w-2 h-2 rounded-full bg-gold shrink-0" />
                    <h3 className="font-serif text-lg text-charcoal">LPOA — Limited Power of Attorney</h3>
                  </div>
                  <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-3 pl-5">
                    Mid-Range Timeline
                  </p>
            ...
            <div className="glass-card rounded-2xl px-8 py-7">
              <div className="flex flex-col sm:flex-row sm:items-start gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <div className="w-2 h-2 rounded-full bg-gold shrink-0" />
                    <h3 className="font-serif text-lg text-charcoal">Repaper / ACAT</h3>
                  </div>
                  <p className="font-sans text-xs text-charcoal-muted uppercase tracking-widest mb-3 pl-5">
                    Longest Method
                  </p>
        ...
        <section className="mb-24">
          ...
          <div className="glass-card-dark rounded-2xl px-10 py-9">
            <p className="font-sans text-sm leading-8 text-charcoal">
              ...
              <span className="font-semibold text-charcoal">01 / 13</span>. Use the{" "}
              <span className="font-semibold text-charcoal">Next</span> and{" "}
              <span className="font-semibold text-charcoal">Back</span> buttons at the bottom of each page to
